...
<script id="groupbtn-template" type="text/x-handlebars-template">
            ...
            <div>
                <div class="section_visual">
                    ...
                    <div class="group_btn_goto">
                        ...
                        <a class="btn_goto_tel" title="전화" href="tel:010-7446-5509"> <i class="fn fn-call1"></i> </a>
						<a class="btn_goto_mail" title="이메일" href="mailto:jinhyn91@naver.com"> <i class="fn fn-mail1"></i> </a>
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            ...
                            <ul class="list_short_review">
                                ...
                                <li class="list_item" data-comment = "2">
                                    <div>
                                        <div class="review_area">
                                            <div class="thumb_area">
                                                <a href="#" class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="http://naverbooking.phinf.naver.net/20170306_3/1488772023601A4195_JPEG/image.jpg?type=f300_300" alt="리뷰이미지"> </a> <span class="img_count">1</span>                                                </div>
